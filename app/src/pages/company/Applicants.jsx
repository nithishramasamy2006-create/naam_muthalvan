    ...
    <div className="flex h-screen overflow-hidden bg-[#06030F]">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="sticky top-0 z-10 bg-[#06030F]/90 backdrop-blur-xl border-b border-white/5 px-8 py-5">
          ...
          <p className="text-white/35 text-sm">8 pending applications — screen and shortlist talent</p>
        </div>
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
          className="p-8 flex flex-col items-center justify-center min-h-[70vh] text-center">
          <div className="text-8xl mb-6">👥</div>
          <h2 className="font-outfit font-bold text-3xl text-white mb-3">Applicants</h2>
          <p className="text-white/35 text-sm max-w-md leading-relaxed mb-8">8 pending applications — screen and shortlist talent</p>
