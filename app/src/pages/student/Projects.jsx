    ...
    <div className="flex h-screen overflow-hidden bg-[#06030F]">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
          ...
          <h2 className="font-outfit font-bold text-3xl text-white mb-3">Browse Projects</h2>
          <p className="text-white/35 text-sm max-w-md leading-relaxed mb-8">384 live projects across Tamil Nadu</p>
